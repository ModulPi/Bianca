...
from backend.application.dashboard.cache import get_or_set
...
from backend.application.summary.serialize import session_row_to_summary
from backend.domain.trading.mode import get_trading_mode
from backend.application.validation.paper_gate import evaluate_validation
