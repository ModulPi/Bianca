...
from backend.domain.llm.analyzer import MarketAnalyzer
from backend.domain.llm.prompts import base_asset_for_symbol, normalize_symbol, resolve_worker_symbol
from backend.domain.llm.schemas import AnalysisResult, TradeSignal
from backend.infrastructure.storage.repository import DecisionRepository, AnalysisReportRepository
...
async def run_analysis_agent(
    ...
    *,
    ...
    from backend.application.metrics import record_llm_call
