...
from backend.application.metrics import record_trade
from backend.infrastructure.storage.repository import AgentConfigRepository, TradeRepository
...
async def run_execute_agent(state: TradeState, *, settings: Settings | None = None) -> TradeState:
    ...
    from backend.application.validation.paper_gate import assert_demo_mode_for_trading
