...
from backend.application.graph.strategy_tools import evaluate_trend_for_symbol, list_running_strategies
...
async def run_strategy_agent(
    ...
    *,
    ...
    if running:
        from backend.application.graph.strategy_tools import evaluate_strategy_by_id
