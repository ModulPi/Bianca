...
from backend.domain.llm.prompts import base_asset_for_symbol
from backend.infrastructure.storage.json_utils import parse_json_field
from backend.infrastructure.storage.models import SessionSummaryRow, TradeLog
...
from backend.application.summary.pnl import PnLResult, compute_pnl
from backend.application.summary.positions import resolve_session_positions
...
async def close_session(
    *,
    ...
    await persist_session_summary(summary)
    try:
        from backend.infrastructure.notify.telegram import format_session_summary, notify_session_closed
        from backend.infrastructure.notify.email import send_email
