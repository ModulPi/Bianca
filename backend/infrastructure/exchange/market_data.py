...
from backend.infrastructure.exchange.futures_coin_demo import FuturesCoinDemoExchange, _coin_symbol
from backend.infrastructure.exchange.futures_demo import FuturesDemoExchange
from backend.infrastructure.exchange.spot_demo import SpotDemoExchange, resolve_market_symbol
...
async def fetch_market_snapshot(
    *,
    ...
    from backend.domain.trading.mode import get_trading_mode

    if cfg.market_stream_enabled and cfg.trade_market == "crypto":
        from backend.infrastructure.market.ticker_cache import get_fresh_ticker
