...
from backend.infrastructure.checkpoint.store import checkpointer_backend
from backend.config import get_settings
from backend.application.confirmation.service import confirm_pending_for_strategy, confirm_pending_signal
from backend.application.dashboard.invalidate import invalidate_dashboard_snapshot
from backend.infrastructure.exchange._client import format_binance_error
from backend.infrastructure.exchange.quotes import (
    balance_to_response,
...
async def agent_status() -> AgentStatusResponse:
    from backend.application.dashboard.snapshot import build_agent_status
...
async def run_analysis(body: AnalysisRequest | None = None) -> AnalysisResponse:
    ...
    from backend.application.graph.analysis_agent import run_analysis_agent
