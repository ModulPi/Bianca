...
from backend.interfaces.api.schemas import SessionListResponse, SessionSummaryResponse
...
from backend.application.summary.aggregator import build_session_summary, close_session
