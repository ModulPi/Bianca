...
from backend.infrastructure.cache.redis_client import cache_get, cache_set, clear_active_session, set_active_session
from backend.config import Settings, clear_settings_cache
from backend.infrastructure.storage.database import is_postgres_url, is_sqlite_url
...
async def test_session_cache_helpers():
    ...
    from backend.infrastructure.cache.redis_client import get_active_session
